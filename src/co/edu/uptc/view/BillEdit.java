...
public class BillEdit extends JPanel{
    JLabel nFactlabel ;
    JLabel dateLabel ;
    JLabel clientLabel ;
    JLabel amountLabel ;
    ...
    public BillEdit(ActionListener listener) {
    ...
    public UptcList<String> getTexts(){
        UptcList<String> aux  = new UptcList<>();
        aux.add(getAmountTextField.getText());
        return aux;
    }
    ...
    public void addLabels(){
        ...
        totalCostLabel.setBounds(100,620,100,20);
    ...
    public void setData(String billNumber, String billDate, String clientDoc, UptcList<Productos> products, UptcList<Integer> amounts, double subTotal, double iva, double total) {
        nFacturaT.setText(billNumber);
        fechaText.setText(billDate);
        clienteTextField.setText(clientDoc);
        this.productosList = products;
        this.amounts = amounts;
        setSubToTextField(subTotal);
        setIVATextField(iva);
        setTotalTextField(total);
        createTable();
        for (int i = 0; i < productosList.size(); i++) {
            System.out.println(productosList.get(i).getCiu());
        }
    }
}